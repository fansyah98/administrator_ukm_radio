            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <img src="<?= base_url() ?>assets/img/undraw_Coding_re_iv621.png" class="col-lg-6 d-none d-lg-block "></img>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"> silakan login </h1>
                                    </div>
                                    <form action="<?= site_url('auth/process') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button name="login" class="btn btn-primary btn-user btn-block">
                                                Masuk <i class="fa fa-sign-in-alt"></i>
                                            </button>
                                        </div>
